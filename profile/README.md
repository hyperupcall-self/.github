[Edwin's](https://github.com/hyperupcall) personal repositories. They can be broken up into three categories:

## General

- [slides](https://github.com/fox-self/slides)
- [containers](https://github.com/fox-self/containers)
- [devcontainers](https://github.com/fox-self/devcontainers)
- [virtual-machines](https://github.com/fox-self/virtual-machines)
- [stars](https://github.com/fox-self/stars)
- [packages](https://github.com/fox-self/packages)
...
- [android-app-hyperupcall](https://github.com/fox-self/android-app-hyperupcall)
